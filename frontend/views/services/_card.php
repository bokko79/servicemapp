    ...
    <div class="action-area">
        ...
        <?php if($state==null or $state==''): ?>
            <?php if($model->object->models): ?>
                ...
                <?= Html::a('<i class="fa fa-plus-circle"></i>&nbsp;'.Yii::t('app', 'Ponudi'), Url::to('/presentation-oms/'.slug($model->name)), ['class'=>'btn btn-warning', 'style'=>'']) ?>
            <?php else: ?>
        ...
        <?php else: ?>
            <?php if($model->object->models): ?>
                ...
                <?= $state=='present' ? Html::a('<i class="fa fa-plus-circle"></i>&nbsp;'.Yii::t('app', 'Ponudi'), Url::to('/presentation-oms/'.slug($model->name)), ['class'=>'btn btn-warning', 'style'=>'']) : null ?>
            <?php else: ?>
