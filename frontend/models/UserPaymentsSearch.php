...
/**
 * UserPaymentsSearch represents the model behind the search form about `frontend\models\UserPayment`.
 */
class UserPaymentsSearch extends UserPayment
{
    ...
    public function rules()
    {
        return [
            [['id', 'user_id'], 'integer'],
            [['payment_type', 'details', 'card_no', 'exp_mnth', 'exp_year', 'scc', 'first_name', 'last_name', 'street', 'city', 'zip', 'country', 'status', 'time', 'opis'], 'safe'],
        ];
    }
