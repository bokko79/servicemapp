...
$menuItems[] = ['label' => 'Izveštaj stanja', 'url' => [Yii::$app->user->username.'/finances'], 'options'=>['class'=>((Yii::$app->controller->getRoute()=='user/finances') ? 'active' : null)]];
$menuItems[] = ['label' => 'Transakcije', 'url' => [Yii::$app->user->username.'/transactions'], 'options'=>['class'=>((Yii::$app->controller->getRoute()=='transactions/index') ? 'active' : null)]];
