...
<div class="wrapper headline" style="">
    <label class="head">
        <span class="badge"><?php // $model->noSpecs ?></span>&nbsp;
...
<?php foreach($model_specs as $model_spec) {
		...
		echo $this->render('specification/'.$property->formType.'.php', ['form'=>$form, 'key'=>$property->id, 'model_spec'=>$model_spec, 'specification'=>$specification, 'property'=>$property, 'service'=>$service, 'object_type'=>$service->service_object]);        
