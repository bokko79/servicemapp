...
<?php
	...
	if ($services):
		foreach ($services as $model): ?>    		
	    	<div class="card_container record-full transparent bottom-bordered no-shadow no-margin fadeInUp animated" id="card_container" style="">
			    <div class="primary-context overflow-hidden low-margin">
			    	...
			    	<div class="title">
			    		<div class="head major regular" style="line-height: 22px;">
			    			...
			    			<?= Html::a('<i class="fa fa-bars"></i>&nbsp;'.Yii::t('app', 'Pregled ponuda'), Url::to(['/presentations', 'PresentationsSearch[service_id]'=>$model->id, 'PresentationsSearch[object_models][]'=>$object->id]), ['class'=>'btn btn-link btn-xs', 'style'=>'']) ?>
