...
/**
 * This is the model class for table "cs_property_values_translation".
 *
 * @property string $id
...
class CsPropertyValuesTranslation extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['property_value_id', 'lang_code', 'name', 'name_akk', 'orig_name'], 'required'],
            [['property_value_id'], 'integer'],
            [['lang_code'], 'string', 'max' => 2],
            [['name', 'name_akk', 'orig_name'], 'string', 'max' => 128],
            [['hint'], 'string', 'max' => 256],
