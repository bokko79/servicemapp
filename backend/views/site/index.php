...
<div id="card-widgets">
    <div class="row">
        ...
        <div class="card">
            <div class="card-image waves-effect waves-block waves-light">
              <img class="activator" src="images/cards/info/info_docs<?= rand(0,9) ?>.jpg">
            </div>
            <div class="card-content">
        ...
        <div class="col s12 m6 l4">
            <div id="flight-card" class="card">
                ...
                <div class="card-content-bg white-text" style="background: url('../images/cards/info/info_docs<?= rand(0,9) ?>.jpg');">
                    <div class="card-content">
        ...
        <div class="col s12 m6 l4">
            <div id="profile-card" class="card">
                <div class="card-image waves-effect waves-block waves-light">
                    <img class="activator" src="images/cards/info/info_docs<?= rand(0,9) ?>.jpg" alt="user background">
                </div>
                <div class="card-content">
                    <img src="images/cards/default_avatar.jpg" alt="" class="circle responsive-img activator card-profile-image">
    ...
    <div class="row">
        ...
        <div class="col s12 m12 l4">
            ...
            <div class="card">
                <div class="card-image waves-effect waves-block waves-light">
                    <img src="images/cards/info/info_docs<?= rand(0,9) ?>.jpg" alt="blog-img">
                </div>
            ...
            <div class="product-card">
                <div class="card">
                    <div class="card-image waves-effect waves-block waves-light">
                        ...
                        <img src="images/cards/info/info_docs<?= rand(0,9) ?>.jpg" alt="product-img">
                    </div>
                    <ul class="card-action-buttons">
