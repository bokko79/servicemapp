...
<div class="wrapper headline" style="" id="title">
    <label class="head">
        ...
        <?= Yii::t('app', 'Opis Vašeg poslovanja') ?>
    </label>
    <i class="fa fa-chevron-right chevron"></i>
</div>
<div class="wrapper body notshown fadeIn animated" style="border-top:none;" id="sections05">
<?= $this->render('../_hint.php', ['message'=>$message]) ?>
	<?= $form->field($portfolio, 'name', [])->input('text', ['value'=>'Moj portfolio']) ?>    
	<?= $form->field($portfolio, 'description')->widget(TinyMce::className(), [
		    'options' => ['rows' => 6],
		    'language' => 'sr',
		    'clientOptions' => [
		        'plugins' => [
