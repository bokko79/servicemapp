...
/**
 * CsMethodsSearch represents the model behind the search form about `common\models\CsMethods`.
 */
class CsMethodsSearch extends CsMethods
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['action_name', 'property_name', 'default_value', 'description'], 'safe'],
        ];
    }
