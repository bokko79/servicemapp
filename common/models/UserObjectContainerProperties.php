...
/**
 * This is the model class for table "user_object_container_properties".
 *
 * @property string $id
 ...
 */
class UserObjectContainerProperties extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'user_object_container_properties';
    }
    ...
    {
        return [
            [['user_object_id', 'object_property_id'], 'required'],
            [['user_object_id', 'object_property_id', 'multiple_values', 'read_only'], 'integer'],
