...
<?php foreach($model_methods as $model_method) {
		...
		echo $this->render('method/'.$property->formTypePresentation.'.php', ['form'=>$form, 'key'=>$property->id, 'model_method'=>$model_method, 'method'=>$method, 'property'=>$property, 'service'=>$service]);
	} ?>    
</div>