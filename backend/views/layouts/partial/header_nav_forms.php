          ...
          <div class="grid-right media_control">
              <?php
                if (Yii::$app->user->isGuest) {
                    ...
                    $menuItems[] = ['label' => '<i class="fa fa-bell-o  fa-lg"></i>', 'linkOptions' => ['data-toggle'=>'modal', 'data-target'=>'#uac-modal']];
                    ...
                    $menuItems[] = [
                        'label' => '<i class="fa fa-bell-o fa-lg"></i> <span class="label label-warning">17</span>',    
                        'items' => [
                ...
                $menuItems[] = ['label' => '<i class="fa fa-shopping-cart fa-lg"></i> <span class="label label-warning">2</span>', 'url' => ['/index'], 'options' => ['class'=>'shopping-cart badger'], 'linkOptions' => ['class'=>'btn btn-success']];  
