...
/**
 * This is the model class for table "provider_portfolio_certifications".
 *
 * @property string $id
 ...
 */
class ProviderPortfolioCertifications extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'provider_portfolio_certifications';
    }
