...
?>
<?php if($user and $user->provider and $user->provider->presWithSameObject($object->id)!=null and $service->object_ownership!='provider' and Yii::$app->controller->action->id=='create'){ ?>    
