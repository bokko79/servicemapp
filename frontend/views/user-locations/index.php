...
/* @var $searchModel frontend\models\ProviderServicesSearchUserLocations */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'User Locations');
...
$this->pageTitle = [
    'icon' => 'cube',     
    'title' => Html::encode($this->title).Html::a('<i class="fa fa-plus-circle"></i>&nbsp;'.Yii::t('app', 'Dodaj novi predmet'), Url::to('/new-location'), ['class' => 'btn btn-success btn-sm float-right']),
