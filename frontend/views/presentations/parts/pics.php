...
<?php
if($user && $user->provider->presWithSameObject($object->id)!=null && $service->service_object!=1 and Yii::$app->controller->action->id=='create'){ // zaostali div iz _similar_pics ?>
    </div>
<?php } ?>
