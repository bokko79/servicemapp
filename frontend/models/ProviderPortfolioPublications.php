...
/**
 * This is the model class for table "provider_portfolio_publications".
 *
 * @property string $id
 ...
 */
class ProviderPortfolioPublications extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'provider_portfolio_publications';
    }
