		...
		<?php $form = kartik\widgets\ActiveForm::begin([
			...
			<?php if($model->object_ownership=='provider'): ?>
				...
				<div class="enclosedCheckboxes">
					...
					<?= $form->field(new \common\models\CsObjects, 'id[]')->checkboxList($model->objectModelsList, ['unselect'=>null, 'class'=>'column3 multiselect'])->label(false) ?>
				</div>
			<?php else: ?>
					<?= $form->field(new \common\models\CsObjects, 'id[]')->radioList($model->objectModelsList, ['unselect'=>null, 'class'=>'column3 multiselect'])->label(false) ?>
			<?php endif; ?>
