...
/**
 * This is the model class for table "provider_portfolio_educations".
 *
 * @property string $id
 ...
 */
class ProviderPortfolioEducations extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'provider_portfolio_educations';
    }
